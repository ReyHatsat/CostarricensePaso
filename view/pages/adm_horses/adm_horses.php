...
<div class="container-fluid p-4" id="table_view">
  <div class="row">
    <div class="col-md-12">
      <div class="card">
          <div class="card-header">
            <h2 class="mb-0">Horses</h2>
          </div>
          <div class="card-body">
            <button class="btn btn-dark text-light toggle_horse_view-btn" id="add_horse-btn">
              Add Horse
            </button>
            <hr>
            <table id="tablehorses"
              style="width:100%"
...
<div id="add_horse_view" class="d-none container">
  <div class="row pt-5 text-center">
      <button class="btn btn-dark text-light toggle_horse_view-btn">
        Back to List
      </button>
      ...
      <div class="row">
        ...
        <div class="col-md-12">
          <button class="btn btn-dark" id="btn-loadFile">Import File</button>
          <button class="btn btn-dark" id="btn_gen_file">Export File</button>
      ...
      <div class="col-md-12">
          <h4>Select Owner of the Horse</h4>
          <hr>
          <div class="form-group">
              <select id="current_owner" class="form-control"></select>
          </div>
      </div>
      ...
      <div class="col-md-12 pt-5">
          ...
          <div class="custom-control custom-switch">
              ...
              <label class="custom-control-label" for="i_am_current_owner"> Current owner is the first owner </label>
          </div>
